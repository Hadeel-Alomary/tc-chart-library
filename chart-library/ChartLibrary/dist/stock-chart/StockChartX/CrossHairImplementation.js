    ...
    function CrossHairImplementation(config) {
        ...
        _this._chartSideContextMenu = new ChartSideContextMenu({
            ...
            onShow: function () {
                ...
                var market = ChartAccessorService.instance.getMarketBySymbol(_this.chart.instrument.symbol);
                var priceStep = ChartAccessorService.instance.getMarketsTickSizeService().getTickSize(market.abbreviation, _this._currentPositionPrice);
