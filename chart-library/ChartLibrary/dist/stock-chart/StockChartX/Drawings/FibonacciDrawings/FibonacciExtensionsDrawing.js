...
var FibonacciExtensionsDrawing = (function (_super) {
    __extends(FibonacciExtensionsDrawing, _super);
    function FibonacciExtensionsDrawing() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    Object.defineProperty(FibonacciExtensionsDrawing, "className", {
        get: function () {
    ...
    Object.defineProperty(FibonacciExtensionsDrawing.prototype, "reverse", {
        get: function () {
    ...
    Object.defineProperty(FibonacciExtensionsDrawing.prototype, "levelLinesExtension", {
        get: function () {
    ...
    Object.defineProperty(FibonacciExtensionsDrawing.prototype, "pointsNeeded", {
        get: function () {
            return 2;
        },
        enumerable: false,
    ...
    FibonacciExtensionsDrawing.prototype.bounds = function () {
        var points = this.cartesianPoints();
        if (points.length < this.pointsNeeded)
            return null;
        var radius = Geometry.length(points[0], points[1]);
        return {
            left: points[1].x - radius,
            top: points[1].y - radius,
            width: 2 * radius,
            height: 2 * radius
        };
    };
    FibonacciExtensionsDrawing.prototype.hitTest = function (point) {
        var points = this.cartesianPoints();
        if (points.length < this.pointsNeeded)
            return false;
    ...
    FibonacciExtensionsDrawing.prototype.getLevelY = function (quarter, points, levelValue) {
        var levelPrice = this._calculateValueByY(quarter, levelValue), y = this.projection.yByValue(levelPrice);
        return y;
    };
    FibonacciExtensionsDrawing.prototype._handlePanGesture = function (gesture, event) {
    ...
    FibonacciExtensionsDrawing.prototype.draw = function () {
        if (!this.visible)
            return;
        var points = this.cartesianPoints();
        if (points.length === 0)
    ...
    FibonacciExtensionsDrawing.prototype._getQuarter = function (points) {
        var quarter = 0;
    ...
    FibonacciExtensionsDrawing.prototype._calculateValueByY = function (quarter, levelValue) {
        var firstPrice = this.chartPoints[0].value;
        var secondPrice = this.chartPoints[1].value;
        switch (quarter) {
            case 1:
    ...
    FibonacciExtensionsDrawing.prototype._linesXRange = function (points) {
    ...
    FibonacciExtensionsDrawing.prototype._adjustWithTextWidth = function (x, text, textTheme) {
        switch (this.levelLinesExtension) {
            case FibonacciLevelLineExtension.LEFT:
    ...
    return FibonacciExtensionsDrawing;
}(FibonacciDrawingBase));
export { FibonacciExtensionsDrawing };
Drawing.register(FibonacciExtensionsDrawing);
//# sourceMappingURL=FibonacciExtensionsDrawing.js.map