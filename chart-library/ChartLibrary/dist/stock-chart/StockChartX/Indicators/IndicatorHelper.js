import { AccumulationDistribution, AccumulatedLiquidityByNetValue, AccumulatedLiquidityByNetVolume, AccumulativeSwingIndex, Aroon, AroonOscillator, AverageTrueRange, BollingerBands, BullishBarishIndicator, CenterOfGravity, ChaikinMoneyFlow, ChaikinVolatility, ChandeForecastOscillator, ChandeMomentumOscillator, CommodityChannelIndex, ComparativeRelativeStrength, Const, CoppockCurve, DetrendedPriceOscillator, DirectionalDivergenceIndex, DirectionalMovementAverage, DirectionalMovementIndex, AverageDirectionalIndex, DonchianChannels, DoubleExponentialMovingAverage, DynamicMovingAverage, EaseOfMovement, EhlerFisherTransform, ElderForceIndex, ElderRay, ElderThermometer, ExponentialMovingAverage, TripleExponentialMovingAverage, HullMovingAverage, FractalChaosBands, FractalChaosOscillator, GopalakrishnanRangeIndex, HHV, HighLowBands, HighMinusLow, HistoricalVolatility, IchimokuKinkoHyo, IntradayMomentumIndex, KeltnerChannel, KlingerVolumeOscillator, LastIndicator, LinearRegressionForecast, LinearRegressionIntercept, LinearRegressionRSquared, LinearRegressionSlope, LiquidityByNetValue, LiquidityByNetVolume, LiquidityByValue, LiquidityByVolume, LLV, MACD, MACDHistogram, MarketFacilitationIndex, MassIndex, MedianPrice, MomentumOscillator, MoneyFlowIndex, MovingAverageEnvelope, MaximumValue, NegativeVolumeIndex, OnBalanceVolume, ParabolicSAR, PerformanceIndex, PositiveVolumeIndex, PrettyGoodOscillator, PriceOscillator, PriceROC, PriceVolumeTrend, PrimeNumberBands, PrimeNumberOscillator, PsychologicalLine, QStick, RainbowOscillator, RandomWalkIndex, RAVI, RelativeStrengthIndex, SchaffTrendCycle, SimpleMovingAverage, StandardDeviation, STARC, StochasticMomentumIndex, StochasticOscillator, StochasticRSI, SwingIndex, TimeSeriesForecast, TimeSeriesMovingAverage, TradeVolumeIndex, TriangularMovingAverage, TRIX, TrueRange, TwiggsMoneyFlow, TypicalPrice, UltimateOscillator, Unknown, VariableMovingAverage, VerticalHorizontalFilter, VIDYA, VolumeChange, VolumeMACD, VolumeIndicator, VolumeOscillator, VolumeProfilerSessionVolume, VolumeProfilerVisibleRange, VolumeROC, VolatilityRatio, WeightedClose, WeightedMovingAverage, WellesWilderSmoothing, WilliamsAccumulationDistribution, WilliamsPctR, ZigZag, ZigZagLabel, VolumeWeightedAveragePrice, FastStochastic, PSLandisReversal } from '../../TASdk/TASdk';
import { IndicatorField, vwapIndicatorParam } from './IndicatorConst';
var IndicatorHelper = (function () {
    function IndicatorHelper() {
    }
    IndicatorHelper.indicatorToString = function (indicatorTypeId) {
    ...
    IndicatorHelper.isExistedIndicator = function (indicatorTypeId) {
        switch (indicatorTypeId) {
            case SimpleMovingAverage:
            case ExponentialMovingAverage:
            case DoubleExponentialMovingAverage:
    ...
    IndicatorHelper.getDesktopShortName = function (indicatorTypeId) {
        switch (indicatorTypeId) {
            case SimpleMovingAverage:
                return "SMA";
            case ExponentialMovingAverage:
    ...
    IndicatorHelper.getMobileShortName = function (indicatorTypeId) {
        switch (indicatorTypeId) {
            case SimpleMovingAverage:
                return "SMA";
            case ExponentialMovingAverage:
    ...
    IndicatorHelper.getPlotName = function (fieldName) {
        switch (fieldName) {
    ...
    IndicatorHelper.isLiquidityIndicator = function (indicator) {
    ...
    IndicatorHelper.allIndicators = function () {
        return this.bands().concat(this.general(), this.indices(), this.regressions(), this.movingAverages(), this.oscillators());
    };
    IndicatorHelper.bands = function () {
        return [
            IchimokuKinkoHyo,
            BollingerBands,
    ...
    IndicatorHelper.general = function () {
        return [
            HighMinusLow,
            MedianPrice,
            TypicalPrice,
    ...
    IndicatorHelper.indices = function () {
        return [
            MoneyFlowIndex,
            TradeVolumeIndex,
            SwingIndex,
    ...
    IndicatorHelper.regressions = function () {
        return [
    ...
    IndicatorHelper.movingAverages = function () {
        return [
            SimpleMovingAverage,
    ...
    IndicatorHelper.oscillators = function () {
        return [
    ...
    IndicatorHelper.getMaTypeString = function (maType) {
        switch (maType) {
    ...
    IndicatorHelper.getVwapTypeString = function (vwapType) {
        switch (vwapType) {
    ...
    IndicatorHelper.isAlertable = function (indicatorTypeId) {
        switch (indicatorTypeId) {
            case BollingerBands:
            case MovingAverageEnvelope:
            case KeltnerChannel:
    ...
    IndicatorHelper.getServerIndicatorFields = function (indicatorTypeId) {
        switch (indicatorTypeId) {
            case Unknown:
                return ['CLOSE'];
            case BollingerBands: {
...
export { IndicatorHelper };
//# sourceMappingURL=IndicatorHelper.js.map