...
var NewsTooltip = (function (_super) {
    ...
    NewsTooltip.prototype._setDimensions = function () {
        $(IDS.TABLE_ID).css('width', "".concat(this.width, "px"));
        $(IDS.TABLE_ID).css('height', "".concat(this.height, "px"));
    };
    ...
    NewsTooltip.prototype.showTooltip = function () {
        ...
        this.setPosition(this._config.chartPanel, this._config.mousePosition, "".concat(this.getTableId()), this.width);
    };
