...
var SnbcapitalStreamer = (function (_super) {
    ...
    SnbcapitalStreamer.prototype.subscribeSnbCapitalTopics = function (portfolios) {
        var orderTopic = "SNB." + portfolios[0].gBSCustomerCode + ".ORDER";
        var positionTopic = "SNB." + portfolios[0].gBSCustomerCode + ".POSITION";
        for (var _i = 0, portfolios_1 = portfolios; _i < portfolios_1.length; _i++) {
            var portfolio = portfolios_1[_i];
            var purchasePowerTopic = "SNB." + portfolio.cashAccountCode + "_" + portfolio.cashAccountBranchCode + ".CASHBALANCE";
