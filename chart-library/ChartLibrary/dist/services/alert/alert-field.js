var AlertField = (function () {
    function AlertField(id, name) {
        this.id = id;
        this.name = name;
    }
    AlertField.getFieldById = function (id) {
        return AlertField.getFields().find(function (field) { return field.id == id; });
    };
    AlertField.getFields = function () {
        if (AlertField.fields.length <= 0) {
            ...
            AlertField.fields.push(new AlertField('bidvolume', 'حجم  افضل طلب'));
            AlertField.fields.push(new AlertField('bidprice', 'الطلب'));
            AlertField.fields.push(new AlertField('askprice', 'العرض'));
            AlertField.fields.push(new AlertField('askvolume', 'حجم افضل عرض'));
...
export { AlertField };
//# sourceMappingURL=alert-field.js.map