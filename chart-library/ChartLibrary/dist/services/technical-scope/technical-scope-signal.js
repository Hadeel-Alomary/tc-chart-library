...
var TechnicalScopeSignal = (function () {
    function TechnicalScopeSignal(id, name, symbol, time, signal, topic, arabicMessage, englishMessage, signalState, color) {
        this.id = id;
        this.name = name;
        this.symbol = symbol;
        this.time = time;
    ...
    TechnicalScopeSignal.formatTechnicalScopeSignal = function (company, message) {
        var newState = TechnicalScopeSignal.evalTechnicalSignalState(message.signal, message.value);
        var newColor = TechnicalScopeSignal.getSignalColor(newState.state);
    ...
    TechnicalScopeSignal.getSignalColor = function (technicalScopeState) {
    ...
    TechnicalScopeSignal.getTechnicalScopeStrategies = function () {
    ...
    TechnicalScopeSignal.buildTechnicalScopeStrategies = function () {
        ...
        TechnicalScopeSignal.technicalScopeStrategies['stod-level'] = {
            key: 'stod-level',
            arabic: 'Stochastic D - تشبع الشراء',
            english: 'Stochastic D - Over Bought-Sold',
            category: TechnicalScopeCategoryType.OVER_BOUGHT_OVER_SOLD
        };
        TechnicalScopeSignal.technicalScopeStrategies['stok-level'] = {
            key: 'stok-level',
            arabic: 'Stochastic K - تشبع الشراء',
            english: 'Stochastic K - Over Bought-Sold',
            category: TechnicalScopeCategoryType.OVER_BOUGHT_OVER_SOLD
        };
        TechnicalScopeSignal.technicalScopeStrategies['stochrsi-level'] = {
            key: 'stochrsi-level',
            arabic: 'StochasticRSI - تشبع الشراء',
            english: 'StochasticRSI - Over Bought-Sold',
            category: TechnicalScopeCategoryType.OVER_BOUGHT_OVER_SOLD
        };
        TechnicalScopeSignal.technicalScopeStrategies['cci-level'] = {
            key: 'cci-level',
            arabic: 'CCI - تشبع الشراء',
            english: 'CCI - Over Bought-Sold',
            category: TechnicalScopeCategoryType.OVER_BOUGHT_OVER_SOLD
        };
        TechnicalScopeSignal.technicalScopeStrategies['mfi-level'] = {
            key: 'mfi-level',
            arabic: 'MFI - تشبع الشراء',
            english: 'MFI - Over Bought-Sold',
            category: TechnicalScopeCategoryType.OVER_BOUGHT_OVER_SOLD
        };
        TechnicalScopeSignal.technicalScopeStrategies['wr-level'] = {
            key: 'wr-level',
            arabic: 'Williams %R - تشبع الشراء',
            english: 'Williams %R - Over Bought-Sold',
            category: TechnicalScopeCategoryType.OVER_BOUGHT_OVER_SOLD
        };
        return TechnicalScopeSignal.technicalScopeStrategies;
    };
    return TechnicalScopeSignal;
}());
export { TechnicalScopeSignal };
export var TechnicalScopeStateType;
(function (TechnicalScopeStateType) {
    TechnicalScopeStateType[TechnicalScopeStateType["positive"] = 1] = "positive";
    TechnicalScopeStateType[TechnicalScopeStateType["negative"] = 2] = "negative";
})(TechnicalScopeStateType || (TechnicalScopeStateType = {}));
export var TechnicalScopeCategoryType;
(function (TechnicalScopeCategoryType) {
    TechnicalScopeCategoryType[TechnicalScopeCategoryType["MA_EMA_CROSS"] = 1] = "MA_EMA_CROSS";
    TechnicalScopeCategoryType[TechnicalScopeCategoryType["DIFFERENT_INDICATORS_CROSS"] = 2] = "DIFFERENT_INDICATORS_CROSS";
    TechnicalScopeCategoryType[TechnicalScopeCategoryType["TECHNICAL_SIGNALS"] = 3] = "TECHNICAL_SIGNALS";
    TechnicalScopeCategoryType[TechnicalScopeCategoryType["OVER_BOUGHT_OVER_SOLD"] = 4] = "OVER_BOUGHT_OVER_SOLD";
})(TechnicalScopeCategoryType || (TechnicalScopeCategoryType = {}));
//# sourceMappingURL=technical-scope-signal.js.map