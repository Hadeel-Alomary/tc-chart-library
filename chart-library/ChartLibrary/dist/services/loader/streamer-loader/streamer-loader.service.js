...
var StreamerLoader = (function () {
    function StreamerLoader(http) {
        this.http = http;
    }
    ...
    StreamerLoader.prototype.processResponse = function (response) {
        if (response == null) {
            response = '';
        }
    ...
    return StreamerLoader;
}());
export { StreamerLoader };
//# sourceMappingURL=streamer-loader.service.js.map