...
var TechnicalScopeLoader = (function (_super) {
    ...
    TechnicalScopeLoader.prototype.loadTechnicalScopeHistoricalData = function (interval, marketAbbr) {
        var _this = this;
        var baseUrl = '', language = this.languageService.arabic ? 'ARABIC' : 'ENGLISH', url = baseUrl + '?' + "language=".concat(language, "&interval=").concat(interval, "&market=").concat(marketAbbr);
