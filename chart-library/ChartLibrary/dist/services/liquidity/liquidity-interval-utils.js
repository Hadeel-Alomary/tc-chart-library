...
var LiquidityIntervalUtils = (function () {
    function LiquidityIntervalUtils() {
    }
    LiquidityIntervalUtils.fromIntervalString = function (intervalString) {
    ...
    LiquidityIntervalUtils.toIntervalString = function (interval) {
    ...
    LiquidityIntervalUtils.getBaseInterval = function (interval) {
    ...
    return LiquidityIntervalUtils;
}());
export { LiquidityIntervalUtils };
//# sourceMappingURL=liquidity-interval-utils.js.map