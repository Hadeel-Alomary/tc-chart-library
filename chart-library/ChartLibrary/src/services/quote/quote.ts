...
export class Quote {
    ...
    private static subscribersQuoteFields: string[] = ['ovalue', 'ovolume', 'otrades', 'cvalue', 'cvolume', 'ctrades'];
    ...
    constructor(company: Company, market: string, companyFlag: CompanyFlag, sector: Sector, isSubscriber: boolean) {
