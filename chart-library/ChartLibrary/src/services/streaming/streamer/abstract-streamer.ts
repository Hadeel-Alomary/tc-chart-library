...
export abstract class AbstractStreamer {
    ...
    constructor(private heartbeatManager:HeartbeatManager, private marketAbbr:string) {}
    ...
    protected subscribeTopics(topics:string[]) {
        ...
        groupedTopics.forEach(groupedTopic =>  this.channel.subscribeTopic(groupedTopic));
    }
