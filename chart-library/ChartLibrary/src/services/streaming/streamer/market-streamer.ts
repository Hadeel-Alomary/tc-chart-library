...
export class MarketStreamer extends AbstractStreamer {
    ...
    private marketDepthByPriceTopic:string = 'MBP';
    private marketDepthByOrderTopic:string = 'MBO';
    ...
    constructor(heartbeatManager:HeartbeatManager, private streamerMarket:Market, private debugModeService:DebugModeService,private authorizationService:AuthorizationService){
        ...
        if(this.marketDepthByPriceTopic == 'MBP10') {
            this.marketDepthByOrderTopic = 'MBO10';
        }
    ...
    protected onMessageReceive(message:{[key:string]:unknown}) {
        ...
        switch(messageType){
            ...
            case MessageType.CHART_INTRADAY:
                this.processChartIntradayMessage(message as unknown as RealTimeChartUpdaterMessage);
                break;
            case MessageType.CHART_DAILY:
                this.processChartDailyMessage(message as unknown as RealTimeChartUpdaterMessage);
                break;
            default:
