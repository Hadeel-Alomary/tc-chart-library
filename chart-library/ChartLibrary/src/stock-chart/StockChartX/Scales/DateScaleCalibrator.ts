 ...
 * @typedef {object} DateScaleMajorTick
 * @type {object}
 ...
 * @typedef {object} DateScaleMinorTick
 * @type {object}
 * @property {number} x The x coordinate of the tick mark.
 * @memberOf
 */
...
class DateScaleCalibratorRegistrar {
     ...
     * @memberOf DateScaleCalibrator
     */
    static register(type: typeof DateScaleCalibrator): void;
    static register(className: string, constructor: IConstructor<IDateScaleCalibrator>): void;
    static register(typeOrClassName: string | typeof DateScaleCalibrator, constructor?: IConstructor<IDateScaleCalibrator>) {
        if (typeof typeOrClassName === 'string')
            this._calibrators.register(typeOrClassName, constructor);
        else
            this._calibrators.register(typeOrClassName.className, <IConstructor<IDateScaleCalibrator>> (typeOrClassName as unknown));
    }
 ...
 * @constructor DateScaleCalibrator
 */
export abstract class DateScaleCalibrator implements IDateScaleCalibrator {
    ...
    // DateScaleCalibratorRegistrar mixin
     ...
     * @method calibrate
     * @param {DateScale} dateScale The date scale.
     * @memberOf DateScaleCalibrator#
     */
     ...
     * @memberOf DateScaleCalibrator#
     * @see [loadState]{@linkcode DateScaleCalibrator#loadState}
     */
    saveState(): IDateScaleCalibratorState {
        return {
            className: (this.constructor as typeof DateScaleCalibrator).className,
     ...
     * @memberOf DateScaleCalibrator#
     * @see [saveState]{@linkcode DateScaleCalibrator#saveState}
     */
