 ...
 * @constructor FibonacciExtensionsDrawing
 * @augments Drawing
 * @example
 *  // Create fibonacci extensions drawing.
 *  var extensions1 = new FibonacciExtensionsDrawing({
     *      points: [{x: 10, y: 20}, {x: 50, y: 60}, {x: 100, y: 20}]
     *  });
 *
 *  // Create fibonacci extensions drawing.
 *  var extensions2 = new FibonacciExtensionsDrawing({
 ...
 *  var extensions3 = new FibonacciExtensionsDrawing({
     *      points: [{record: 10, value: 20.0}, {record: 50, value: 60.0}, {record: 100, value: 20.0}],
     *      theme: {
     *          line: {
     *              strokeColor: '#FF0000'
     ...
     *  });
 */
export class FibonacciExtensionsDrawing extends FibonacciDrawingBase<FibonacciExtendedLevelsDrawingTheme> {
    ...
    private _calculateValueByY(quarter: number, levelValue: number): number {
        ...
        let firstPrice = this.chartPoints[0].value;
        let secondPrice = this.chartPoints[1].value;
        switch (quarter) {
            case 1:
