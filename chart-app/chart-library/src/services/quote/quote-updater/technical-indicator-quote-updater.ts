...
import {TechnicalIndicatorColumns, TechnicalIndicatorQuoteService} from "../../../services";

export class TechnicalIndicatorQuoteUpdater extends QuoteUpdater {

    constructor( private technicalIndicatorQuoteService: TechnicalIndicatorQuoteService) {
        super();
